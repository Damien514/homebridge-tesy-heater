...
class TesyHeater {
  ...
  getActive(callback) {
    ...
    var command = 'curl -i -b cookie.txt -c cookie.txt -d "user=benov@benov.org&pass=tecpevel" https://www.mytesy.com/?do=login'
    var command2 = 'curl -i -b cookie.txt -c cookie.txt "https://www.mytesy.com/?do=get_dev&req=1613040616763"'
    var command3 = 'curl -i -b cookie.txt -c cookie.txt "https://www.mytesy.com/?cmd=status&id=08187a17c22923bdd76d26f980220d78aa7c1b20"'
  ...
  setActive(value, callback) {
    ...
    var command = 'curl -i -b cookie.txt -c cookie.txt -d "user=benov@benov.org&pass=tecpevel" https://www.mytesy.com/?do=login'
    var command2 = 'curl -i -b cookie.txt -c cookie.txt "https://www.mytesy.com/?do=get_dev&req=1613040616763"'
    var command3 = 'curl -i -b cookie.txt -c cookie.txt "https://www.mytesy.com/?cmd=power2status&val=' + newValue + '&id=08187a17c22923bdd76d26f980220d78aa7c1b20"'
  ...
  setHeatingThresholdTemperature(value, callback) {
    ...
    var command = 'curl -i -b cookie.txt -c cookie.txt -d "user=benov@benov.org&pass=tecpevel" https://www.mytesy.com/?do=login'
    var command2 = 'curl -i -b cookie.txt -c cookie.txt "https://www.mytesy.com/?do=get_dev&req=1613040616763"'
    var command3 = 'curl -i -b cookie.txt -c cookie.txt "https://www.mytesy.com/?cmd=setTemp&val=' + value + '&id=08187a17c22923bdd76d26f980220d78aa7c1b20"'
